...
--
-- Name: calcular_total_servicos(jsonb, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.calcular_total_servicos(ids jsonb, id_estab integer) RETURNS numeric
    LANGUAGE plpgsql
    AS $$
DECLARE
    total numeric := 0;
BEGIN
    ...
    INTO total
    FROM servicos s
    JOIN jsonb_array_elements_text(ids) AS j(id) ON s.id = j.id::int
    WHERE s.id_estabelecimento = id_estab;
...
ALTER FUNCTION public.calcular_total_servicos(ids jsonb, id_estab integer) OWNER TO postgres;
...
--
-- Name: idx_agendamentos_id_estabelecimento; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_agendamentos_id_estabelecimento ON public.agendamentos USING btree (id_estabelecimento);


--
-- Name: idx_agendamentos_id_horario; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_agendamentos_id_horario ON public.agendamentos USING btree (id_horario);
...
--
-- Name: idx_horarios_estab_dia; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_horarios_estab_dia ON public.horarios USING btree (id_estabelecimento, dia);


--
-- Name: idx_horarios_prof_dia; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_horarios_prof_dia ON public.horarios USING btree (id_profissional, dia);
